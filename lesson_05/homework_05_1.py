...
# for car_brand in car_data.keys():
#     print(car_brand)
# print()
...
#print(f"year: {year}, engine_volume: {engine_volume}, price: {price}")

# for car in car_data.values():
#     if car[1] >= year and car[2] >= engine_volume and car[4] <= price:
#         print(car)
# print()
...
search_results_v1 = []
founded_car = None
for brand, attributes in car_data.items():
    #print(f"brand: {brand}, attributes: {attributes}")
    if attributes[1] >= year and attributes[2] >= engine_volume and attributes[4] <= price:
        #print(f"brand: {brand}, attributes: {attributes}")
        founded_car = (brand, attributes)
        search_results_v1.append(founded_car)

# for car in search_results_v1:
#     print(car)
# print()
...
for car in search_results_v2:
    print(car)
print()

# Sorted only first 5 cars that satisfy search_criteria
# sort by 3 parameters: 1st - price, 2nd - year, 3rd - engine volume
print("Sorted only first 5 cars that satisfy search_criteria:")

search_results_v2.sort(key=lambda x: (x[-1], x[2], x[3] ))

for car in search_results_v2[:5]:
    print(car)

    #print(*car)
    #brand, color, year, engine, car_type, price = car
    #print(f"Brand: {brand} | color: {color} | year: {year} | engine: {engine}, car type: {car_type}, price: {price}")
